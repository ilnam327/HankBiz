package com.sunflower.widget.photo;
...
public class AsyncImageLoader {
    ...
    public Drawable loadDrawable( String imageUrl, final ImageCallback imageCallback) {
        final String imgUrl=NetUtil.SERVER_IMG+imageUrl;
